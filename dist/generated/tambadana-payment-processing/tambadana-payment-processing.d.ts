...
import type { BanksOnlyAccountNumberRegexPriority, CancelPayment, CreateDirectDebitRequest, CreateDisbursePayloadBody, CurlecCompleteRegistrationDirectDebitPayload, CurlecCompleteRequestDirectDebitPayload, CurlecInitRegistrationDirectDebitPayloadBody, CurlecInitiatePaymentPayloadBody, CurlecUpdateMandatePayload, CurlecUpdatePaymentPayload, DataAsyncTask, DataBanks, DataBanksMany, DataBanksManyPaginated, DataCountDisbursementsByStatusesResponseMany, DataCurlecInitRegistrationDirectDebitResponse, DataCurlecInitiatePaymentResponse, DataDDEntitiesCountByStatusesResponseMany, DataDDRequestsCountByStatusesResponseMany, DataDirectDebitEntity, DataDirectDebitEntityManyPaginated, DataDirectDebitRequest, DataDirectDebitRequestManyPaginated, DataDisbursement, DataDisbursementManyPaginated, DataDisbursementStatuses, DataGetPaymentsBanksResponseMany, DataInc2c2pInitiatePaymentResponse, DataInitRegistrationDDResponse, DataLivenessResponse, DataPayexInitiatePaymentResponse, DataPayment, DataPaymentManyPaginated, DataPaymentMethodMany, DataPaymentProof, DataPaymentProofManyPaginated, DataPaymentProofOnlyIdStatus, DataPaymentStatsAggregatedResponseMany, DataPaymentStatsResponse, DataPaymentsResponse, DataProvidersMany, DataPurchase, DataReadinessResponse, DataRefundAllByContractResponse, DataRefundManyPaginated, DataSuccessResponse, DataValidateBankAccountResult, DeleteApiPaymentProcessingCrmDirectDebitEntitiesIdParams, DeleteApiPaymentProcessingDirectDebitEntitiesIdParams, DisbursePayloadBody, DisbursementOnlyErrorDescription, FailDisburseByExtPayload, FailDisbursePayloadBody, GetApiPaymentProcessingBanksParams, GetApiPaymentProcessingBanksParentIdLocalBankCodesParams, GetApiPaymentProcessingCrmBanksPaginatedParams, GetApiPaymentProcessingCrmBanksParams, GetApiPaymentProcessingCrmBanksParentIdLocalBankCodesParams, GetApiPaymentProcessingCrmDirectDebitEntitiesCountByStatusesParams, GetApiPaymentProcessingCrmDirectDebitEntitiesDefaultParams, GetApiPaymentProcessingCrmDirectDebitEntitiesParams, GetApiPaymentProcessingCrmDirectDebitRequestsCountByStatusesParams, GetApiPaymentProcessingCrmDirectDebitRequestsParams, GetApiPaymentProcessingCrmDisbursementsCountByStatusesParams, GetApiPaymentProcessingCrmDisbursementsParams, GetApiPaymentProcessingCrmFullPaymentsParams, GetApiPaymentProcessingCrmPaymentProofParams, GetApiPaymentProcessingCrmPaymentsMethodsParams, GetApiPaymentProcessingCrmPaymentsParams, GetApiPaymentProcessingCrmPaymentsStatsAggregateBySourceParams, GetApiPaymentProcessingCrmPaymentsStatsParams, GetApiPaymentProcessingCrmProvidersParams, GetApiPaymentProcessingCrmRefundsParams, GetApiPaymentProcessingCurlecPaymentsBanksParams, GetApiPaymentProcessingDirectDebitEntitiesDefaultParams, GetApiPaymentProcessingDirectDebitEntitiesParams, GetApiPaymentProcessingPaymentsMethodsParams, Inc2c2pInitiatePaymentPayloadBody, Inc2c2pUpdatePaymentPayload, InitRegistrationDDPayloadBody, PayexInitiatePaymentPayload, PayexUpdatePaymentPayload, PaymentOnlyContractKey, PaymentPayload, PaymentProofOnlyStatus, PostApiPaymentProcessingCrmPaymentProofBody, PostApiPaymentProcessingExcelFilePaymentsBody, PostApiPaymentProcessingPaymentProofBody, ProvidersFiltersOnlyId, PurchaseAddDetailsPayload, PurchaseOnlyExternalIdBody, RedirectBody, RefundAllByContractPayload, RegisterOrRequestDirectDebitPayload, UpdateDisbursePayload, ValidateBankAccountPayload } from "./model";
/**
 ...
 */
export declare const postApiPaymentProcessingCurlecPaymentsInitiate: (curlecInitiatePaymentPayloadBody: CurlecInitiatePaymentPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataCurlecInitiatePaymentResponse>>;
export declare const getPostApiPaymentProcessingCurlecPaymentsInitiateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
        data: CurlecInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
    data: CurlecInitiatePaymentPayloadBody;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecPaymentsInitiateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecPaymentsInitiate>>>;
export declare type PostApiPaymentProcessingCurlecPaymentsInitiateMutationBody = CurlecInitiatePaymentPayloadBody;
export declare type PostApiPaymentProcessingCurlecPaymentsInitiateMutationError = AxiosError<unknown>;
/**
 * @summary Initiate payment
 */
export declare const usePostApiPaymentProcessingCurlecPaymentsInitiate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
        data: CurlecInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
    data: CurlecInitiatePaymentPayloadBody;
}, TContext>;
/**
 * @summary Initiate payment
 */
export declare const postApiPaymentProcessingCrmCurlecPaymentsInitiate: (curlecInitiatePaymentPayloadBody: CurlecInitiatePaymentPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataCurlecInitiatePaymentResponse>>;
export declare const getPostApiPaymentProcessingCrmCurlecPaymentsInitiateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
        data: CurlecInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
export declare type PostApiPaymentProcessingCrmCurlecPaymentsInitiateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCrmCurlecPaymentsInitiate>>>;
export declare type PostApiPaymentProcessingCrmCurlecPaymentsInitiateMutationBody = CurlecInitiatePaymentPayloadBody;
export declare type PostApiPaymentProcessingCrmCurlecPaymentsInitiateMutationError = AxiosError<unknown>;
/**
 * @summary Initiate payment
 */
export declare const usePostApiPaymentProcessingCrmCurlecPaymentsInitiate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitiatePaymentResponse, any>, TError, {
        data: CurlecInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingCurlecPaymentsUpdate: (curlecUpdatePaymentPayload: CurlecUpdatePaymentPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingCurlecPaymentsUpdateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: CurlecUpdatePaymentPayload;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecPaymentsUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecPaymentsUpdate>>>;
export declare type PostApiPaymentProcessingCurlecPaymentsUpdateMutationBody = CurlecUpdatePaymentPayload;
export declare type PostApiPaymentProcessingCurlecPaymentsUpdateMutationError = AxiosError<unknown>;
/**
 * @summary Update payment
 */
export declare const usePostApiPaymentProcessingCurlecPaymentsUpdate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
/**
 * @summary Get banks available for payments
 */
export declare const getApiPaymentProcessingCurlecPaymentsBanks: (params: GetApiPaymentProcessingCurlecPaymentsBanksParams, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataGetPaymentsBanksResponseMany>>;
export declare const getGetApiPaymentProcessingCurlecPaymentsBanksQueryKey: (params: GetApiPaymentProcessingCurlecPaymentsBanksParams) => readonly ["/api/payment-processing/curlec/payments/banks", ...GetApiPaymentProcessingCurlecPaymentsBanksParams[]];
export declare const getGetApiPaymentProcessingCurlecPaymentsBanksQueryOptions: <TData = AxiosResponse<DataGetPaymentsBanksResponseMany, any>, TError = AxiosError<unknown, any>>(params: GetApiPaymentProcessingCurlecPaymentsBanksParams, options?: {
    query?: UseQueryOptions<AxiosResponse<DataGetPaymentsBanksResponseMany, any>, TError, TData, QueryKey> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseQueryOptions<AxiosResponse<DataGetPaymentsBanksResponseMany, any>, TError, TData, QueryKey> & {
    queryKey: QueryKey;
};
export declare type GetApiPaymentProcessingCurlecPaymentsBanksQueryResult = NonNullable<Awaited<ReturnType<typeof getApiPaymentProcessingCurlecPaymentsBanks>>>;
export declare type GetApiPaymentProcessingCurlecPaymentsBanksQueryError = AxiosError<unknown>;
/**
 * @summary Get banks available for payments
 */
export declare const useGetApiPaymentProcessingCurlecPaymentsBanks: <TData = AxiosResponse<DataGetPaymentsBanksResponseMany, any>, TError = AxiosError<unknown, any>>(params: GetApiPaymentProcessingCurlecPaymentsBanksParams, options?: {
    query?: UseQueryOptions<AxiosResponse<DataGetPaymentsBanksResponseMany, any>, TError, TData, QueryKey> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseQueryResult<TData, TError> & {
    queryKey: QueryKey;
...
/**
 * @summary Initiate direct debit registration
 */
export declare const postApiPaymentProcessingCurlecDirectDebitInitRegistration: (curlecInitRegistrationDirectDebitPayloadBody: CurlecInitRegistrationDirectDebitPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse>>;
export declare const getPostApiPaymentProcessingCurlecDirectDebitInitRegistrationMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
        data: CurlecInitRegistrationDirectDebitPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
    data: CurlecInitRegistrationDirectDebitPayloadBody;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecDirectDebitInitRegistrationMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecDirectDebitInitRegistration>>>;
export declare type PostApiPaymentProcessingCurlecDirectDebitInitRegistrationMutationBody = CurlecInitRegistrationDirectDebitPayloadBody;
export declare type PostApiPaymentProcessingCurlecDirectDebitInitRegistrationMutationError = AxiosError<unknown>;
/**
 * @summary Initiate direct debit registration
 */
export declare const usePostApiPaymentProcessingCurlecDirectDebitInitRegistration: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
        data: CurlecInitRegistrationDirectDebitPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
    data: CurlecInitRegistrationDirectDebitPayloadBody;
}, TContext>;
/**
 * @summary Initiate direct debit registration
 */
export declare const postApiPaymentProcessingCrmCurlecDirectDebitInitRegistration: (curlecInitRegistrationDirectDebitPayloadBody: CurlecInitRegistrationDirectDebitPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse>>;
export declare const getPostApiPaymentProcessingCrmCurlecDirectDebitInitRegistrationMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
        data: CurlecInitRegistrationDirectDebitPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
export declare type PostApiPaymentProcessingCrmCurlecDirectDebitInitRegistrationMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCrmCurlecDirectDebitInitRegistration>>>;
export declare type PostApiPaymentProcessingCrmCurlecDirectDebitInitRegistrationMutationBody = CurlecInitRegistrationDirectDebitPayloadBody;
export declare type PostApiPaymentProcessingCrmCurlecDirectDebitInitRegistrationMutationError = AxiosError<unknown>;
/**
 * @summary Initiate direct debit registration
 */
export declare const usePostApiPaymentProcessingCrmCurlecDirectDebitInitRegistration: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataCurlecInitRegistrationDirectDebitResponse, any>, TError, {
        data: CurlecInitRegistrationDirectDebitPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingCurlecDirectDebitMandateUpdate: (curlecUpdateMandatePayload: CurlecUpdateMandatePayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingCurlecDirectDebitMandateUpdateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecUpdateMandatePayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: CurlecUpdateMandatePayload;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecDirectDebitMandateUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecDirectDebitMandateUpdate>>>;
export declare type PostApiPaymentProcessingCurlecDirectDebitMandateUpdateMutationBody = CurlecUpdateMandatePayload;
export declare type PostApiPaymentProcessingCurlecDirectDebitMandateUpdateMutationError = AxiosError<unknown>;
/**
 * @summary Update mandate status
 */
export declare const usePostApiPaymentProcessingCurlecDirectDebitMandateUpdate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecUpdateMandatePayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
/**
 * @summary Complete direct debit registration
 */
export declare const postApiPaymentProcessingCurlecDirectDebitCompleteRegistration: (curlecCompleteRegistrationDirectDebitPayload: CurlecCompleteRegistrationDirectDebitPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingCurlecDirectDebitCompleteRegistrationMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecCompleteRegistrationDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: CurlecCompleteRegistrationDirectDebitPayload;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRegistrationMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecDirectDebitCompleteRegistration>>>;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRegistrationMutationBody = CurlecCompleteRegistrationDirectDebitPayload;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRegistrationMutationError = AxiosError<unknown>;
/**
 * @summary Complete direct debit registration
 */
export declare const usePostApiPaymentProcessingCurlecDirectDebitCompleteRegistration: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecCompleteRegistrationDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
/**
 * @summary Complete direct debit request
 */
export declare const postApiPaymentProcessingCurlecDirectDebitCompleteRequest: (curlecCompleteRequestDirectDebitPayload: CurlecCompleteRequestDirectDebitPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingCurlecDirectDebitCompleteRequestMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecCompleteRequestDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: CurlecCompleteRequestDirectDebitPayload;
}, TContext>;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRequestMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecDirectDebitCompleteRequest>>>;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRequestMutationBody = CurlecCompleteRequestDirectDebitPayload;
export declare type PostApiPaymentProcessingCurlecDirectDebitCompleteRequestMutationError = AxiosError<unknown>;
/**
 * @summary Complete direct debit request
 */
export declare const usePostApiPaymentProcessingCurlecDirectDebitCompleteRequest: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: CurlecCompleteRequestDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 * @summary Initiate payment
 */
export declare const postApiPaymentProcessingInc2c2pPaymentsInitiate: (inc2c2pInitiatePaymentPayloadBody: Inc2c2pInitiatePaymentPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataInc2c2pInitiatePaymentResponse>>;
export declare const getPostApiPaymentProcessingInc2c2pPaymentsInitiateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
        data: Inc2c2pInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
    data: Inc2c2pInitiatePaymentPayloadBody;
}, TContext>;
export declare type PostApiPaymentProcessingInc2c2pPaymentsInitiateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingInc2c2pPaymentsInitiate>>>;
export declare type PostApiPaymentProcessingInc2c2pPaymentsInitiateMutationBody = Inc2c2pInitiatePaymentPayloadBody;
export declare type PostApiPaymentProcessingInc2c2pPaymentsInitiateMutationError = AxiosError<unknown>;
/**
 * @summary Initiate payment
 */
export declare const usePostApiPaymentProcessingInc2c2pPaymentsInitiate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
        data: Inc2c2pInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
    data: Inc2c2pInitiatePaymentPayloadBody;
}, TContext>;
/**
 * @summary Initiate payment
 */
export declare const postApiPaymentProcessingCrmInc2c2pPaymentsInitiate: (inc2c2pInitiatePaymentPayloadBody: Inc2c2pInitiatePaymentPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataInc2c2pInitiatePaymentResponse>>;
export declare const getPostApiPaymentProcessingCrmInc2c2pPaymentsInitiateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
        data: Inc2c2pInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
export declare type PostApiPaymentProcessingCrmInc2c2pPaymentsInitiateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCrmInc2c2pPaymentsInitiate>>>;
export declare type PostApiPaymentProcessingCrmInc2c2pPaymentsInitiateMutationBody = Inc2c2pInitiatePaymentPayloadBody;
export declare type PostApiPaymentProcessingCrmInc2c2pPaymentsInitiateMutationError = AxiosError<unknown>;
/**
 * @summary Initiate payment
 */
export declare const usePostApiPaymentProcessingCrmInc2c2pPaymentsInitiate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInc2c2pInitiatePaymentResponse, any>, TError, {
        data: Inc2c2pInitiatePaymentPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 * @summary Update payment
 */
export declare const postApiPaymentProcessingInc2c2pPaymentsUpdate: (inc2c2pUpdatePaymentPayload: Inc2c2pUpdatePaymentPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingInc2c2pPaymentsUpdateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: Inc2c2pUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: Inc2c2pUpdatePaymentPayload;
}, TContext>;
export declare type PostApiPaymentProcessingInc2c2pPaymentsUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingInc2c2pPaymentsUpdate>>>;
export declare type PostApiPaymentProcessingInc2c2pPaymentsUpdateMutationBody = Inc2c2pUpdatePaymentPayload;
export declare type PostApiPaymentProcessingInc2c2pPaymentsUpdateMutationError = AxiosError<unknown>;
/**
 * @summary Update payment
 */
export declare const usePostApiPaymentProcessingInc2c2pPaymentsUpdate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: Inc2c2pUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingCurlecDisbursementsUpdate: (updateDisbursePayload: UpdateDisbursePayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingCurlecDisbursementsUpdateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
...
export declare type PostApiPaymentProcessingCurlecDisbursementsUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCurlecDisbursementsUpdate>>>;
export declare type PostApiPaymentProcessingCurlecDisbursementsUpdateMutationBody = UpdateDisbursePayload;
export declare type PostApiPaymentProcessingCurlecDisbursementsUpdateMutationError = AxiosError<unknown>;
/**
 * @summary Update disburse
 */
export declare const usePostApiPaymentProcessingCurlecDisbursementsUpdate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: UpdateDisbursePayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingPayexDirectDebitInitRegistration: (initRegistrationDDPayloadBody: InitRegistrationDDPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataInitRegistrationDDResponse>>;
export declare const getPostApiPaymentProcessingPayexDirectDebitInitRegistrationMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
        data: InitRegistrationDDPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
    data: InitRegistrationDDPayloadBody;
}, TContext>;
export declare type PostApiPaymentProcessingPayexDirectDebitInitRegistrationMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexDirectDebitInitRegistration>>>;
export declare type PostApiPaymentProcessingPayexDirectDebitInitRegistrationMutationBody = InitRegistrationDDPayloadBody;
export declare type PostApiPaymentProcessingPayexDirectDebitInitRegistrationMutationError = AxiosError<unknown>;
/**
 * @summary Init direct debit registration
 */
export declare const usePostApiPaymentProcessingPayexDirectDebitInitRegistration: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
        data: InitRegistrationDDPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
    data: InitRegistrationDDPayloadBody;
}, TContext>;
/**
 * @summary Init Payex direct debit registration
 */
export declare const postApiPaymentProcessingCrmPayexDirectDebitInitRegistration: (initRegistrationDDPayloadBody: InitRegistrationDDPayloadBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataInitRegistrationDDResponse>>;
export declare const getPostApiPaymentProcessingCrmPayexDirectDebitInitRegistrationMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
        data: InitRegistrationDDPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
export declare type PostApiPaymentProcessingCrmPayexDirectDebitInitRegistrationMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingCrmPayexDirectDebitInitRegistration>>>;
export declare type PostApiPaymentProcessingCrmPayexDirectDebitInitRegistrationMutationBody = InitRegistrationDDPayloadBody;
export declare type PostApiPaymentProcessingCrmPayexDirectDebitInitRegistrationMutationError = AxiosError<unknown>;
/**
 * @summary Init Payex direct debit registration
 */
export declare const usePostApiPaymentProcessingCrmPayexDirectDebitInitRegistration: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataInitRegistrationDDResponse, any>, TError, {
        data: InitRegistrationDDPayloadBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequest: (registerOrRequestDirectDebitPayload: RegisterOrRequestDirectDebitPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequestMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: RegisterOrRequestDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: RegisterOrRequestDirectDebitPayload;
}, TContext>;
export declare type PostApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequestMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequest>>>;
export declare type PostApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequestMutationBody = RegisterOrRequestDirectDebitPayload;
export declare type PostApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequestMutationError = AxiosError<unknown>;
/**
 * @summary Complete direct debit registration or request
 */
export declare const usePostApiPaymentProcessingPayexDirectDebitCompleteRegistrationOrRequest: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: RegisterOrRequestDirectDebitPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 */
export declare const postApiPaymentProcessingPayexDirectDebitRedirect: (redirectBody: RedirectBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<unknown>>;
export declare const getPostApiPaymentProcessingPayexDirectDebitRedirectMutationOptions: <TError = AxiosError<void, any>, TContext = unknown>(options?: {
...
export declare type PostApiPaymentProcessingPayexDirectDebitRedirectMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexDirectDebitRedirect>>>;
export declare type PostApiPaymentProcessingPayexDirectDebitRedirectMutationBody = RedirectBody;
export declare type PostApiPaymentProcessingPayexDirectDebitRedirectMutationError = AxiosError<void>;
/**
 * @summary Endpoint for redirecting customer back to app after registration
 */
export declare const usePostApiPaymentProcessingPayexDirectDebitRedirect: <TError = AxiosError<void, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<unknown, any>, TError, {
        data: RedirectBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
 ...
 * @summary Endpoint for redirecting customer back to app after registration
 */
export declare const postApiPaymentProcessingPayexRedirect: (redirectBody: RedirectBody, options?: AxiosRequestConfig) => Promise<AxiosResponse<unknown>>;
export declare const getPostApiPaymentProcessingPayexRedirectMutationOptions: <TError = AxiosError<void, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<unknown, any>, TError, {
        data: RedirectBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
export declare type PostApiPaymentProcessingPayexRedirectMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexRedirect>>>;
export declare type PostApiPaymentProcessingPayexRedirectMutationBody = RedirectBody;
export declare type PostApiPaymentProcessingPayexRedirectMutationError = AxiosError<void>;
/**
 * @summary Endpoint for redirecting customer back to app after registration
 */
export declare const usePostApiPaymentProcessingPayexRedirect: <TError = AxiosError<void, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<unknown, any>, TError, {
        data: RedirectBody;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
/**
 * @summary Refund all dd_requests by contract id
 */
export declare const postApiPaymentProcessingPayexDirectDebitRefundByContract: (refundAllByContractPayload: RefundAllByContractPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataRefundAllByContractResponse>>;
export declare const getPostApiPaymentProcessingPayexDirectDebitRefundByContractMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataRefundAllByContractResponse, any>, TError, {
        data: RefundAllByContractPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataRefundAllByContractResponse, any>, TError, {
    data: RefundAllByContractPayload;
}, TContext>;
export declare type PostApiPaymentProcessingPayexDirectDebitRefundByContractMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexDirectDebitRefundByContract>>>;
export declare type PostApiPaymentProcessingPayexDirectDebitRefundByContractMutationBody = RefundAllByContractPayload;
export declare type PostApiPaymentProcessingPayexDirectDebitRefundByContractMutationError = AxiosError<unknown>;
/**
 * @summary Refund all dd_requests by contract id
 */
export declare const usePostApiPaymentProcessingPayexDirectDebitRefundByContract: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataRefundAllByContractResponse, any>, TError, {
        data: RefundAllByContractPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataRefundAllByContractResponse, any>, TError, {
    data: RefundAllByContractPayload;
}, TContext>;
/**
 * @summary Initiate payment
 */
export declare const postApiPaymentProcessingPayexPaymentsInitiate: (payexInitiatePaymentPayload: PayexInitiatePaymentPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataPayexInitiatePaymentResponse>>;
export declare const getPostApiPaymentProcessingPayexPaymentsInitiateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataPayexInitiatePaymentResponse, any>, TError, {
        data: PayexInitiatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataPayexInitiatePaymentResponse, any>, TError, {
    data: PayexInitiatePaymentPayload;
}, TContext>;
export declare type PostApiPaymentProcessingPayexPaymentsInitiateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexPaymentsInitiate>>>;
export declare type PostApiPaymentProcessingPayexPaymentsInitiateMutationBody = PayexInitiatePaymentPayload;
export declare type PostApiPaymentProcessingPayexPaymentsInitiateMutationError = AxiosError<unknown>;
/**
 * @summary Initiate payment
 */
export declare const usePostApiPaymentProcessingPayexPaymentsInitiate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataPayexInitiatePaymentResponse, any>, TError, {
        data: PayexInitiatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => import("@tanstack/react-query/build/legacy/types").UseMutationResult<AxiosResponse<DataPayexInitiatePaymentResponse, any>, TError, {
    data: PayexInitiatePaymentPayload;
}, TContext>;
/**
 * @summary Update payment
 */
export declare const postApiPaymentProcessingPayexPaymentsUpdate: (payexUpdatePaymentPayload: PayexUpdatePaymentPayload, options?: AxiosRequestConfig) => Promise<AxiosResponse<DataSuccessResponse>>;
export declare const getPostApiPaymentProcessingPayexPaymentsUpdateMutationOptions: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: PayexUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
    data: PayexUpdatePaymentPayload;
}, TContext>;
export declare type PostApiPaymentProcessingPayexPaymentsUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPaymentProcessingPayexPaymentsUpdate>>>;
export declare type PostApiPaymentProcessingPayexPaymentsUpdateMutationBody = PayexUpdatePaymentPayload;
export declare type PostApiPaymentProcessingPayexPaymentsUpdateMutationError = AxiosError<unknown>;
/**
 * @summary Update payment
 */
export declare const usePostApiPaymentProcessingPayexPaymentsUpdate: <TError = AxiosError<unknown, any>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<AxiosResponse<DataSuccessResponse, any>, TError, {
        data: PayexUpdatePaymentPayload;
    }, TContext> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
...
/**
 * @summary Test create direct debit for ready contracts
 */
export declare const getApiPaymentProcessingTestCreateDdForReadyContracts: (options?: AxiosRequestConfig) => Promise<AxiosResponse<DataAsyncTask>>;
export declare const getGetApiPaymentProcessingTestCreateDdForReadyContractsQueryKey: () => readonly ["/api/payment-processing/test/create_dd_for_ready_contracts"];
export declare const getGetApiPaymentProcessingTestCreateDdForReadyContractsQueryOptions: <TData = AxiosResponse<DataAsyncTask, any>, TError = AxiosError<unknown, any>>(options?: {
    query?: UseQueryOptions<AxiosResponse<DataAsyncTask, any>, TError, TData, QueryKey> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseQueryOptions<AxiosResponse<DataAsyncTask, any>, TError, TData, QueryKey> & {
    queryKey: QueryKey;
};
export declare type GetApiPaymentProcessingTestCreateDdForReadyContractsQueryResult = NonNullable<Awaited<ReturnType<typeof getApiPaymentProcessingTestCreateDdForReadyContracts>>>;
export declare type GetApiPaymentProcessingTestCreateDdForReadyContractsQueryError = AxiosError<unknown>;
/**
 * @summary Test create direct debit for ready contracts
 */
export declare const useGetApiPaymentProcessingTestCreateDdForReadyContracts: <TData = AxiosResponse<DataAsyncTask, any>, TError = AxiosError<unknown, any>>(options?: {
    query?: UseQueryOptions<AxiosResponse<DataAsyncTask, any>, TError, TData, QueryKey> | undefined;
    axios?: AxiosRequestConfig<any> | undefined;
} | undefined) => UseQueryResult<TData, TError> & {
    queryKey: QueryKey;
